...
#@load "C:\\Users\\User\\Documents\\PhDWorkspace_with_saturation.jld2"
...
ex3_v200_saturation = Vector{Vector{Vector{Int64}}}()
...
ex3_v201_saturation = Vector{Vector{Vector{Int64}}}()
...
for i in 1:500
    ...
    #push!(ex3_v200_saturation, [sum([any_vec(x,s) for x in getfield.(ex3_v200_sim.buyers, :unit_possessed_history)]) for s in 1:2])
    ...
    #push!(ex3_v201_saturation, [sum([any_vec(x,s) for x in getfield.(ex3_v201_sim.buyers, :unit_possessed_history)]) for s in 1:2])

end

# Czy losowanie jest 'odpowiednio losowe'?

sort(countmap(ex3_v200201_Li))
sort(countmap(ex3_v200201_Lw))
sort(countmap(ex3_v200201_nl))

# Jak zachowują się zyski producentów?
...
# Dlaczego 201_2 ma większe zyski niż 200_2?

Plots.plot(mean(getindex.(ex3_v200_quantity_produced, 1)))
Plots.plot!(mean(getindex.(ex3_v200_quantity_produced, 2)))
Plots.plot!(mean(getindex.(ex3_v201_quantity_produced, 1)))
Plots.plot!(mean(getindex.(ex3_v201_quantity_produced, 2)))

Plots.plot(mean(getindex.(ex3_v200_quantity_sold, 1)))
Plots.plot!(mean(getindex.(ex3_v200_quantity_sold, 2)))
Plots.plot!(mean(getindex.(ex3_v201_quantity_sold, 1)))
Plots.plot!(mean(getindex.(ex3_v201_quantity_sold, 2)))

selling_income_200_2 = sum.(multi.(getindex.(ex3_v200_price, 2), getindex.(ex3_v200_quantity_sold, 2)))
utilization_cost_200_2 = (1 .- ex3_v200201_cu) .* sum.(multi.(divide.(getindex.(ex3_v200_price, 2), getindex.(ex3_v200_margin, 2)), getindex.(ex3_v200_quantity_produced, 2) .- getindex.(ex3_v200_quantity_sold, 2)))
...
avg_diff_200 = mean.(getindex.(ex3_v200_quality, 1)) .- mean.(getindex.(ex3_v200_quality_exp, 1))
avg_diff_201 = mean.(getindex.(ex3_v201_quality, 1)) .- mean.(getindex.(ex3_v201_quality_exp, 1))
avg_diff_profit = (mean.(getindex.(ex3_v201_producer_surplus_singleton, 1)) .- mean.(getindex.(ex3_v200_producer_surplus_singleton, 1)))

StatsPlots.histogram(ex3_v200201_Li, bins = 12)

countmap(ex3_v200201_Li)

Plots.scatter(sort(unique(ex3_v200201_nl)), [mean(avg_diff_200[ex3_v200201_nl .== nl]) for nl in sort(unique(ex3_v200201_nl))])
Plots.scatter(sort(unique(ex3_v200201_nl)), [mean(avg_diff_201[ex3_v200201_nl .== nl]) for nl in sort(unique(ex3_v200201_nl))])
Plots.scatter(sort(unique(ex3_v200201_nl)), [mean(avg_diff_profit[ex3_v200201_nl .== nl]) for nl in sort(unique(ex3_v200201_nl))])

ex3_v201

Plots.scatter(sort(unique(ex3_v200201_nl)), [mean(mean.(getindex.(ex3_v200_producer_surplus_singleton, 1))[ex3_v200201_nl .== nl]) for nl in sort(unique(ex3_v200201_nl))])
Plots.scatter!(sort(unique(ex3_v200201_nl)), [mean(mean.(getindex.(ex3_v201_producer_surplus_singleton, 1))[ex3_v200201_nl .== nl]) for nl in sort(unique(ex3_v200201_nl))])
Plots.scatter!(sort(unique(ex3_v200201_nl)), [mean(mean.(getindex.(ex3_v200_producer_surplus_singleton, 2))[ex3_v200201_nl .== nl]) for nl in sort(unique(ex3_v200201_nl))])
Plots.scatter!(sort(unique(ex3_v200201_nl)), [mean(mean.(getindex.(ex3_v201_producer_surplus_singleton, 2))[ex3_v200201_nl .== nl]) for nl in sort(unique(ex3_v200201_nl))])
...
ex3_4_pl = plot_ecdf(true, sum.(getindex.(ex3_v201_producer_surplus_singleton, 2)), "Producent nie bada oczekiwań konsumentów", xlabel = "Zysk producenta", ylabel = "F(x)", title = "Dystrybuanta empiryczna - zysk producenta")
plot_ecdf(false, sum.(getindex.(ex3_v201_producer_surplus_singleton, 1)), "Producent bada oczekiwania konsumentów")
...
ex3_4_pl = plot_ecdf(true, sum.(getindex.(ex3_v200_quantity_produced,1)) .- sum.(getindex.(ex3_v200_quantity_sold,1)), "Producent nie bada oczekiwań konsumentów", xlabel = "Zysk producenta", ylabel = "F(x)", title = "Dystrybuanta empiryczna - zysk producenta")
plot_ecdf(false, sum.(getindex.(ex3_v201_quantity_produced,1)) .- sum.(getindex.(ex3_v201_quantity_sold,1)), "Producent bada oczekiwania konsumentów")
...
Plots.plot(mean(getindex.(ex3_v200_quality,1)[(ex3_v200201_nl .== 1000) .& (ex3_v200201_Lw .== 1.0).& (ex3_v200201_Li .== 1.0)]))
Plots.plot!(mean(getindex.(ex3_v200_quality_exp, 1)[(ex3_v200201_nl .== 1000).& (ex3_v200201_Lw .== 1.0).& (ex3_v200201_Li .== 1.0)]))

collect(1:2402)[(ex3_v200201_nl .== 1000) .& (ex3_v200201_Lw .== 1.0).& (ex3_v200201_Li .== 1.0)]
644
k=644
...
Plots.plot(mean(getindex.(ex3_v201_quality,1)[(ex3_v200201_nl .== 1000) .& (ex3_v200201_Lw .== 1.0).& (ex3_v200201_Li .== 1.0)]))
Plots.plot!(mean(getindex.(ex3_v201_quality_exp, 1)[(ex3_v200201_nl .== 1000).& (ex3_v200201_Lw .== 1.0).& (ex3_v200201_Li .== 1.0)]))
...
Plots.plot(getindex.(ex3_v200_producer_surplus_singleton, 1)[k])
Plots.plot!(getindex.(ex3_v201_producer_surplus_singleton, 1)[k])
Plots.plot!(getindex.(ex3_v200_producer_surplus_singleton, 2)[k])
Plots.plot!(getindex.(ex3_v201_producer_surplus_singleton, 2)[k])

Plots.plot(getindex.(ex3_v200_producer_surplus_singleton, 1)[4])
Plots.plot!(getindex.(ex3_v201_producer_surplus_singleton, 1)[4])
Plots.plot!(getindex.(ex3_v200_producer_surplus_singleton, 2)[4])
Plots.plot!(getindex.(ex3_v201_producer_surplus_singleton, 2)[4])

Plots.plot(getindex.(ex3_v201_quantity_produced, 1)[k])
Plots.plot!(getindex.(ex3_v201_quantity_sold, 1)[k])
Plots.plot(getindex.(ex3_v200_quantity_produced, 1)[k])
Plots.plot!(getindex.(ex3_v200_quantity_sold, 1)[k])

Plots.plot(getindex.(ex3_v200_margin,1)[k])
Plots.plot!(getindex.(ex3_v201_margin,1)[k])

U(k,d,h,β,p) = β .* k .* (1 .-(0.85 .* d) .^ h) ./ (1 .- (0.85 .* d))  - p

Beta = .6

Plots.plot(U(getindex.(ex3_v200_quality,1)[644], getindex.(ex3_v200_durability,1)[644], ex3_v200201_H[644], Beta, getindex.(ex3_v200_price,1)[644]))
Plots.plot!(U(getindex.(ex3_v201_quality,1)[644], getindex.(ex3_v201_durability,1)[644], ex3_v200201_H[644], Beta, getindex.(ex3_v201_price,1)[644]))



Plots.plot(getindex.(ex3_v201_quantity_produced, 1)[k])
Plots.plot!(getindex.(ex3_v201_quantity_sold, 1)[k])
Plots.plot!(twinx(),getindex.(ex3_v201_producer_surplus_singleton, 1)[k], color = "black")

sum(getindex.(ex3_v200_producer_surplus_singleton, 1)[k])
sum(getindex.(ex3_v201_producer_surplus_singleton, 1)[k])
sum(getindex.(ex3_v200_producer_surplus_singleton, 2)[k])
sum(getindex.(ex3_v201_producer_surplus_singleton, 2)[k])

sum(getindex.(ex3_v200_producer_surplus_singleton, 1)[4])
sum(getindex.(ex3_v201_producer_surplus_singleton, 1)[4])
sum(getindex.(ex3_v200_producer_surplus_singleton, 2)[4])
sum(getindex.(ex3_v201_producer_surplus_singleton, 2)[4])

sum(getindex.(ex3_v200_quantity_produced, 1)[k])
sum(getindex.(ex3_v201_quantity_produced, 1)[k])
sum(getindex.(ex3_v200_quantity_produced, 2)[k])
sum(getindex.(ex3_v201_quantity_produced, 2)[k])

sum(getindex.(ex3_v200_quantity_sold, 1)[k])
sum(getindex.(ex3_v201_quantity_sold, 1)[k])
sum(getindex.(ex3_v200_quantity_sold, 2)[k])
sum(getindex.(ex3_v201_quantity_sold, 2)[k])

sum(getindex.(ex3_v200_quantity_sold, 1)[4])
sum(getindex.(ex3_v201_quantity_sold, 1)[4])
sum(getindex.(ex3_v200_quantity_sold, 2)[4])
sum(getindex.(ex3_v201_quantity_sold, 2)[4])
...
k = 13; println(ex3_v200201_Lw[k]); println(ex3_v200201_Li[k]); println(ex3_v200201_nl[k]); Plots.plot(getindex.(ex3_v201_quality,1)[k]) ; Plots.plot!(getindex.(ex3_v201_quality_exp, 1)[k]); Plots.plot!(getindex.(ex3_v200_quality,1)[k]) ; Plots.plot!(getindex.(ex3_v200_quality_exp, 1)[k])
...
sum.(getindex.(ex3_v201_quantity_sold, 1))
...
ex4_p5 = Plots.scatter(sort(unique(ex3_v200201_nl)) / 200, [mean((mean.(getindex.(ex3_v201_producer_surplus_singleton, 1)) .- mean.(getindex.(ex3_v200_producer_surplus_singleton, 1)))[ex3_v200201_nl .== nl]) for nl in sort(unique(ex3_v200201_nl))], xlabel = "Number of connections per single consumer", ylabel = "Additional profit from market research", title = "Market research incremental effect", color = "red", legend = false, titlefontsize = 14, xlabelfontsize = 14, ylabelfontsize = 14)

mod = GLM.lm(@formula(y~x), DataFrame(x = 1 ./ (sort(unique(ex3_v200201_nl/200))), y = [mean((mean.(getindex.(ex3_v201_producer_surplus_singleton, 1)) .- mean.(getindex.(ex3_v200_producer_surplus_singleton, 1)))[ex3_v200201_nl .== nl]) for nl in sort(unique(ex3_v200201_nl))]))
