...
for i in 1:200
    ...
    ex2_v1_sim = TO_GO(150, 2, 200, 300, [1.0, 1.0], [0.5, 0.5], [1.0, 1.0], [0.4, 0.4], "random", 0.25, 0.25,  "stochastic", ["stochastic", "stochastic"], [[0.5, 1.5], [0.5, 1.5]], [[0.2, 0.6], [0.2, 0.6]], [[0.,2.], [0.,2.]])
    ...
    ex2_v2_sim = TO_GO(150, 2, 200, 300, [1.0, 1.0], [0.5, 0.5], [1.0, 1.0], [0.4, 0.4], "random", 0.25, 0.25,  "stochastic", ["stochastic", "stochastic"], [[1.0, 1.5], [0.5, 1.0]], [[0.4, 0.6], [0.2, 0.4]], [[0.,2.], [0.,2.]])
...
ex2_p2 = plot_ecdf(ex2_v1_consumer_surplus, "equal Q", "Consumer Surplus", "Probability", "ECDF", true)
plot_ecdf(ex2_v2_consumer_surplus, "not equal Q", "Consumer Surplus", "Probability", "ECDF", false)
...
ex2_p3 = plot_ecdf(sum.(sum.(ex2_v1_quantity_sold)), "equal Q", "Producer Surplus", "Probability", "ECDF", true)
